...
const en = {
  ...
  Datasets: {
    ...
    world_209: {
      ...
      dataAttribution: {
        1: 'World Bank, 2024',
        2: 'United Nations (consolidated by RIATE), 2025',
        3: 'Wikipedia, 2024',
      },
    },
    world_242: {
  ...
  FunctionalitiesSection: {
    ...
    AggregationOptions: {
      Method: 'Dissolve method',
      None: 'None',
      Information: 'If no field is selected, the dissolve operation will be done on the entire layer.',
      NewLayerName: 'Dissolved_{layerName}',
    },
  ...
  LayerSettings: {
    ...
    SymbolHorizontalAnchor: 'Horizontal anchoring of the symbol',
    SymbolVerticalAnchor: 'Vertical anchoring of the symbol',
    TextAnchor: 'Text anchor',
  ...
  PortrayalSelection: {
    ...
    ShortDescriptions: {
      ...
      Aggregation: 'This functionality enables polygonal entities to be dissolved according to the value of a field (or all entities if no field is selected).',
      ...
      TrivariateChoropleth: 'A trivariate choropleth map makes it possible to simultaneously represent three relative quantitative variables by using a triangular diagram as a color-mixing space applied across geographic areas.',
    },
  ...
  BivariateClassificationPanel: {
    ...
    BaseColor: 'Base color<br />(lightest)',
    EndColorVar1: 'End color<br />(variable 1)',
    EndColorVar2: 'End color<br />(variable 2)',
  },
  Legend: {
    ContextMenu: {
      EditSettings: 'Edit settings...',
    ...
    Modal: {
      ...
      Radius: 'Radius',
      DisplayRegressionLine: 'Display regression line',
      DisplayCountByClass: 'Display count by class',
